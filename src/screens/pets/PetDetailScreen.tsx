...
export default function PetDetailScreen() {
  ...
  const handleAdopt = () => {
    if (!pet) return;
    Alert.alert('Solicitar adopción', `¿Deseas iniciar el proceso de adopción para ${pet.name}?`, [
      { text: 'Cancelar', style: 'cancel' },
      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            Alert.alert(
              '¡Listo!',
              'Tu solicitud fue enviada. El refugio se comunicará contigo pronto.',
            );
          } catch (e: unknown) {
      ...
      >
        ...
        <View style={[styles.avatar, { backgroundColor: speciesStyle.bg }]}>
          ...
          <View style={styles.speciesBadge}>
            <Text style={[styles.speciesBadgeText, { color: speciesStyle.color }]}>
              {pet?.species}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.infoSection}>
          ...
          <View style={styles.metaRow}>
            ...
            <View style={[styles.metaChip, { backgroundColor: '#dcfce7' }]}>
              <Text style={[styles.metaChipText, { color: '#059669', fontWeight: '700' }]}>
                DISPONIBLE
              </Text>
            </View>
          </View>
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoCardText}>
              Adoptar una mascota es un compromiso de vida. El proceso incluye una visita de
              verificación del refugio.
            </Text>
          </View>
        </View>
      </ScrollView>
